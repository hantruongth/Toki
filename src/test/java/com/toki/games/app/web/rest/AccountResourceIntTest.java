...
import com.toki.games.app.repository.AuthorityRepository;
...
public class AccountResourceIntTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.data.login").value("test"))
            .andExpect(jsonPath("$.data.authorities").value(AuthoritiesConstants.ADMIN));
    }
