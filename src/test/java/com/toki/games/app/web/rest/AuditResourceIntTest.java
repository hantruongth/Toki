...
import com.toki.games.app.config.audit.AuditEventConverter;
import com.toki.games.app.domain.PersistentAuditEvent;
import com.toki.games.app.repository.PersistenceAuditEventRepository;
...
public class AuditResourceIntTest {
    ...
    public void getAudit() throws Exception {
        ...
        restAuditMockMvc.perform(get("/management/audits/{id}", auditEvent.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.data.principal").value(SAMPLE_PRINCIPAL));
    }
    ...
    public void getNonExistingAudit() throws Exception {
        ...
        restAuditMockMvc.perform(get("/management/audits/{id}", Long.MAX_VALUE))
            .andExpect(jsonPath("$.exceptionCode").value("1001"));
    }
