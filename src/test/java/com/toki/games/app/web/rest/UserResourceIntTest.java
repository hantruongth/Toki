...
import com.toki.games.app.TokiGamesApp;
...
import com.toki.games.app.service.mapper.UserMapper;
import com.toki.games.app.web.rest.errors.ExceptionTranslator;
...
@SpringBootTest(classes = TokiGamesApp.class)
public class UserResourceIntTest {
    ...
    private static final String UPDATED_PASSWORD = "passtest";

    private static final String DEFAULT_EMAIL = "johndoe@localhost";
    private static final String UPDATED_EMAIL = "test@localhost";

    private static final String DEFAULT_FIRSTNAME = "john";
    private static final String UPDATED_FIRSTNAME = "testFirstName";

    private static final String DEFAULT_LASTNAME = "doe";
    private static final String UPDATED_LASTNAME = "testLastName";
    ...
    public void createUser() throws Exception {
        ...
        restUserMockMvc.perform(post("/api/users")
            ...
            .andExpect(jsonPath("$.data.login").value(DEFAULT_LOGIN));
    }
    ...
    public void getUser() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/users/{login}", user.getLogin()))
            ...
            .andExpect(jsonPath("$.data.login").value(user.getLogin()));
